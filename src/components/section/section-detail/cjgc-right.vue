 ...
 * @LastEditTime: 2021-06-08 10:31:47
 * @FilePath: /hangzhou-gongquanli/src/components/section/section-detail/cjgc-right.vue
-->
<template>
  <div>
    <div class="cjgc-right-1 w-full relative">
      ...
      <div class="cjgc-right-1-content flex">
    ...
    <div class="cjgc-right-2">
      <sign title="疑似问题线索情况" style="margin-left: -30px;"></sign>
      <div class="cjgc-right-2-content flex">
        <div style="width: 700px;height: 420px;margin-top: 30px;">
          <list-item :data="cityList"></list-item>
        </div>
    ...
    <div class="cjgc-right-3 flex items-center">
      <div class="cjgc-right-3-content">
        <sign title="模型情况"></sign>
        <div style="width: 700px;height: 420px;margin-top: 30px;">
          <list-item :data="cityList"></list-item>
        </div>
      </div>
      <div class="cjgc-right-3-content" style="width: 900px;margin-left: 30px;">
        <sign title="村级工程预警趋势"></sign>
